...
// Consulta SIEMPRE la última suscripción (aunque esté vencida)
...
<head>
  <meta charset="UTF-8">
  <title>Editar Perfil - Manga Verse</title>
...
<header>
  ...
  <div class="profile-name">Hola, <?php echo htmlspecialchars($user['NombreUsuario']); ?></div>
</header>
<div class="main-wrap">
    ...
    <?php if ($rol == 1): ?>
      <div class="badge-box">
        <?php if ($user['EsPremium'] && !$subsVencida): ?>
          <span class="badge">Premium ✅</span><br>
          <?php if ($fechaFinText): ?>
