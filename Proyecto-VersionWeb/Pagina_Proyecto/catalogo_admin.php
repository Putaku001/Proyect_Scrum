      ...
      <div class="catalog-container">
        <div class="catalog-header">
          <form method="GET" action="catalogo_admin.php">
            <input type="text" name="buscar" placeholder="Buscar manga..."
          ...
          <div class="admin-actions">
            <a href="subidaMangaForm.php"><i class="fas fa-plus"></i> Subir nuevo manga</a>
          </div>
        </div>
            ...
            <div class="manga-card">
              <div class="img-wrapper">
                <a href="detalle_manga_admin.php?id=<?= $manga['MangaID'] ?>">
                  <img src="<?= htmlspecialchars($manga['PortadaElegida']) ?>"
                    alt="Portada de <?= htmlspecialchars($manga['Titulo']) ?>">
                </a>
                <div class="card-buttons-top">
                  <a href="editar_manga.php?id=<?= $manga['MangaID'] ?>" title="Editar"><i class="fas fa-edit"></i></a>
                  <a href="eliminar_manga.php?id=<?= $manga['MangaID'] ?>" class="eliminar" title="Eliminar"
                    onclick="return confirm('¿Eliminar este manga?')"><i class="fas fa-trash-alt"></i></a>
                </div>
              </div>
              <div class="info">
