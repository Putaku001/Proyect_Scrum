...
<body>
    ...
    <form class="payment-box" action="procesar_pago.php" method="POST">
        <h2>Pago - <?= ucfirst($plan) ?> ($<?= $precio ?>)</h2>
        ...
        <input type="text" name="expiry_date" required placeholder="MM/AA">
