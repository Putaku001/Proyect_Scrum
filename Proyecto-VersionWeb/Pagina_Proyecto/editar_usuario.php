...
<head>
  <meta charset="UTF-8">
  <title>Editar Usuario - Manga Verse</title>
    ...
    <div class="form-container">
      ...
      <form action="actualizar_usuario.php" method="post">
        ...
        <div class="checkbox-container">
          <label>
            <input type="checkbox" name="premium" value="1" <?= $user['EsPremium'] ? 'checked' : '' ?>>
            Usuario Premium
          </label>
        </div>
      ...
      <a href="admin_panel.php" class="back-link"><i class="fas fa-arrow-left"></i> Volver al panel</a>
    </div>
  </div>
